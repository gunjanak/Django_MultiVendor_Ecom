...
class Command(BaseCommand):
    def handle(self, *args, **options):
        first_name=['Hari',"David","Marcus","Rickey","Saurav",
                    "Nitin","Shovita","Sunita","Silu","Kritika"]
        last_name = ["Patel","Pandit","Punia","Poudel","Panta","Pakekh","Paleker"]
